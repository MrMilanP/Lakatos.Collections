...
namespace Lakatos.Collections.Persistent
{
    ...
    {
        /// <summary>
        /// The head node of the current list.
        /// </summary>
        private readonly Node? head;

        /// <summary>
        /// The previous version of the list, allowing access to the state before the last modification.
        /// </summary>
        private readonly PersistentList<T>? previous;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersistentList{T}"/> class with the specified head node and the previous version of the list.
        /// </summary>
        /// <param name="head">The head node of the current list.</param>
        /// <param name="previous">The previous version of the list. Can be <c>null</c> if this is the initial version.</param>
        /// <remarks>
        /// This constructor is used internally to maintain immutability by creating a new instance every time the list is modified, 
        /// linking the new instance to the previous state.
        /// </remarks>
        private PersistentList(Node? head, PersistentList<T>? previous)
        {
            this.head = head;
        ...
        /// </summary>
        public static readonly PersistentList<T> Empty = new PersistentList<T>(null, null);
        ...
        /// <returns>A new list instance with the element added at the beginning. This ensures immutability by returning a new instance.</returns>
        public PersistentList<T> Add(T item)
        {
            return new PersistentList<T>(new Node(item, head), this);
        }
        ...
        /// <exception cref="InvalidOperationException">Thrown when attempting to remove an element from an empty list to maintain consistent state.</exception>
        public PersistentList<T> Remove()
        {
            ...
            return new PersistentList<T>(head!.Next, this);
        }

        /// <summary>
        /// Checks if the list is empty.
        /// </summary>
        /// <remarks>Indicates whether the list contains any elements.</remarks>
        ...
        /// <remarks>Elements are added in the correct order to maintain the sequence from the original collection.</remarks>
        ...
        /// <remarks>A stack is used internally to preserve the order of the elements in the new list.</remarks>
        ...
        /// <summary>
        /// Gets the previous version of the persistent list. If the list is the initial version, this will be <c>null</c>.
        /// </summary>
        /// <returns>The previous version of the list or <c>null</c> if no previous version exists.</returns>
        /// <remarks>Allows access to the previous state of the list, preserving immutability by returning a new version without modifying the original.</remarks>
        public PersistentList<T>? Previous => previous; // Returns the previous version of the list or null if none exists.
        ...
        /// <remarks>The list is reversed to maintain original order if requested.</remarks>
        ...
        /// <remarks>Logs the state of the sorted list for debugging purposes.</remarks>
        ...
        /// <remarks>This method is called recursively to create a new list version with the element inserted at the correct position.</remarks>
        private PersistentList<T> InsertSorted(PersistentList<T> list, T item, Func<T, T, int> comparer)
        {
            ...
            return new PersistentList<T>(newNode, list);
        }
